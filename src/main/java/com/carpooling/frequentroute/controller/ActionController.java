...
import com.carpooling.frequentroute.repositoryFirebase.InfoRepository;
...
public class ActionController {
    ...
    @GetMapping("/test")
    @ResponseBody
    public Request getRequest(@RequestParam("id") String id) {
    ...
    @GetMapping("/info")
    @ResponseBody
    public Info getInfo(@RequestParam("id") String id) {
        return infoRepository.get(id,new Object());
    }
